...
(function() {
  ...
  tally = function(root, obj) {
    ...
    var TAL, altAttr, attr, attr2, beforeAttr, beforeText, doc, formInputHasBody, format, getProp, html, i, innerText, len, list, listStack, name, node, obj2, objList, pos, posStack, prefix, qattr, qdef, qdup, qif, qrepeat, qtext, querySelectorAll, resolve, tmpNode, value, wrapper, _results;
    wrapper = function() {};
    ...
    qattr = qdef.qattr || "data-tally-attr";
    qtext = qdef.qtext || "data-tally-text";
    qdup = qdef.qdup || "data-tally-dup";
    format = qdef.format;
    qdef = qdef.qdef || "data-tally-def";
