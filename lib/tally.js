...
(function() {
  ...
  tally = function(root, obj) {
    ...
    var TAL, altAttr, attr, attr2, attributeWillChange, doc, formInputHasBody, format, getProp, html, i, innerText, len, list, listStack, name, node, obj2, objList, pos, posStack, prefix, qattr, qdef, qdup, qif, qrepeat, qtext, querySelectorAll, resolve, textWillChange, tmpNode, value, wrapper, _results;
    wrapper = function() {};
